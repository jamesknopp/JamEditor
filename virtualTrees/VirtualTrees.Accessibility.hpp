...
public:
	_di_IAccessible __fastcall CreateIAccessible(Virtualtrees::Basetree::TBaseVirtualTree* ATree);
public:
...
public:
	...
	operator Virtualtrees::Accessibilityfactory::_di_IVTAccessibleProvider()
	{
		Virtualtrees::Accessibilityfactory::_di_IVTAccessibleProvider intf;
		this->GetInterface(intf);
		return intf;
	}
	#else
