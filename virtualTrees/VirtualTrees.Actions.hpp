...
private:
	Virtualtrees::Basetree::TBaseVirtualTree* fTree;
...
protected:
	Virtualtrees::Types::TVirtualNodeStates fFilter;
	void __fastcall SetControl(Virtualtrees::Basetree::TBaseVirtualTree* Value);
...
__published:
	...
	__property Virtualtrees::Basetree::TBaseVirtualTree* Control = {read=fTree, write=SetControl};
...
protected:
	Virtualtrees::Basetree::_di_TVTGetNodeProc fToExecute;
...
protected:
	Virtualtrees::Basetree::TCheckState fDesiredCheckState;
