...
//-- type declarations -------------------------------------------------------
__interface  INTERFACE_UUID("{8B76176B-C1F2-4C5C-99B4-2444FABE495C}") IVTAccessibleProvider  : public System::IInterface 
{
	virtual _di_IAccessible __fastcall CreateIAccessible(Virtualtrees::Basetree::TBaseVirtualTree* ATree) = 0 ;
};
...
public:
	...
	_di_IAccessible __fastcall CreateIAccessible(Vcl::Controls::TCustomControl* ATree);
